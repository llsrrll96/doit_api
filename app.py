...
db = DB()
search =Search(db.get_hscode_en_ko())           # all_Combine : HS6,HSCODE,NM_EN,NM_KO
category= Category(db.get_category_data())      # 카테고리
history = History(db.get_history_data())        # HSCODE,NM,이유,설명
